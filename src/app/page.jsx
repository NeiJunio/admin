            ...
            <div className={styles.main_content}>
                ...
                <div id="clientes" className={`${styles.content_section} ${styles.hidden}`}>
                    ...
                    {/* <form id="clienteForm" className={styles.form}>
                        ...
                        <div className={styles.input_row}>
                            <div className={`${styles.input_wrapper} ${styles.input_medium}`}>
                                <label htmlFor="data" className={styles.label}>Data de nascimento:</label>
                                <input type="date" id="data" name="data" required className={styles.input} />
                            </div>
                            <div className={`${styles.input_wrapper} ${styles.input_medium}`}>
                                <label htmlFor="sexo" className={styles.label}>Sexo:</label>
                                <select id="sexo" name="sexo" required className={styles.select}>
                        ...
                        <div className={styles.input_row}>
                            <div className={styles.input_wrapper}>
                                ...
                                <input type="text" id="endereco" name="endereco" required className={styles.input} />
                            </div>
                        </div>
