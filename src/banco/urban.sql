...
--
-- Host: 127.0.0.1
-- Tempo de geração: 21/06/2024 às 21:10
...
INSERT INTO `veiculos` (`veic_id`, `mod_id`, `veic_placa`, `veic_ano`, `veic_cor`, `veic_combustivel`, `veic_observ`) VALUES
(1, 1, 'ABC1234', '2020', 'Prata', 'Diesel', 'Observacoes sobre o veiculo ABC1234 - caminhao'),
(2, 2, 'DEF5678', '2018', 'Preto', 'Diesel', 'Observacoes sobre o veiculo DEF5678 - caminhao'),
(3, 3, 'GHI9012', '2022', 'Branco', 'Diesel', 'Observacoes sobre o veiculo GHI9012 - caminhao'),
(4, 481, 'JKL3456', '2019', 'Vermelho', 'Flex', 'Observacoes sobre o veiculo JKL3456 - carro'),
(5, 934, 'MNO7890', '2021', 'Azul', 'Gasolina', 'Observacoes sobre o veiculo MNO7890 - carro'),
(6, 504, 'PQR1234', '2017', 'Prata', 'Alcool', 'Observacoes sobre o veiculo PQR1234 - carro'),
(7, 1582, 'STU5678', '2020', 'Preto', 'Gasolina', 'Observacoes sobre o veiculo STU5678 - moto'),
(8, 1586, 'VWX9012', '2023', 'Branco', 'Gasolina', 'Observacoes sobre o veiculo VWX9012 - moto');
...
ALTER TABLE `servicos`
  ...
  ADD KEY `cat_serv_id` (`cat_serv_id`);
...
ALTER TABLE `veiculos`
  ...
  ADD UNIQUE KEY `veic_id` (`veic_id`);
...
--
ALTER TABLE `marcas`
  MODIFY `mar_id` int(11) NOT NULL AUTO_INCREMENT, AUTO_INCREMENT=273;
...
--
ALTER TABLE `veiculos`
  MODIFY `veic_id` int(11) NOT NULL AUTO_INCREMENT, AUTO_INCREMENT=9;
...
--
ALTER TABLE `servicos`
  ADD CONSTRAINT `servicos_ibfk_1` FOREIGN KEY (`cat_serv_id`) REFERENCES `categorias_servicos` (`cat_serv_id`);
COMMIT;
