...
INSERT INTO usuarios (usu_nome, usu_cpf, usu_data_nasc, usu_sexo, usu_telefone, usu_email, usu_observ, usu_acesso, usu_senha) VALUES
                     ('Fulano de Tal', '123.456.789-00', '1990-01-01', 1, '(11) 1234-5678', 'fulano@example.com', 'Observações sobre Fulano de Tal.', 1, 'senha123'),
                     ('Ciclano da Silva', '987.654.321-00', '1985-05-15', 0, '(11) 9876-5432', 'ciclano@example.com', 'Observações sobre Ciclano da Silva.', 1, 'senha456'),
                     ('Beltrano Oliveira', '321.654.987-00', '1995-10-20', 1, '(11) 5432-1098', 'beltrano@example.com', 'Observações sobre Beltrano Oliveira.', 0, 'senha789'),
